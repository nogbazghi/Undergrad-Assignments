...
#         elif love[argument] not in POST:
#             print "It is not possible to present a summary without a Noun"
#
#
...
#             #print sentence
#             for node in (sentence[1:]): print node.getWordForm(),
#             print '\n'
